...
const AddToCartButton = ({ product, addToCart }) => {
  ...
  return (
    <div className="flex items-center">
      <button onClick={handleDecrease} className="bg-gray-300 text-black py-1 px-2 rounded-l-md" aria-label="Diminuer la quantité">-</button>
      <input
        type="number"
        value={quantity}
      ...
      />
      <button onClick={handleIncrease} className="bg-gray-300 text-black py-1 px-2 rounded-r-md" aria-label="Augmenter la quantité">+</button>
      <button 
